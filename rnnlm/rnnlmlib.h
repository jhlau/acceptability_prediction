...
protected:
    ...
    char wordclass_file[MAX_STRING];

    int print_word_class;
...
*/	
    ...
    void setWordClassFile(char *str);
    ...
    void setNumThreads(int newVal) {num_threads=newVal;}
    ...
    void saveContext(struct neuron *neu1, struct neuron *neu1b);
    void restoreContext(struct neuron *neu1, struct neuron *neu1b);
    void saveContext2(struct neuron *neu1, struct neuron *neu1b2);
    void restoreContext2(struct neuron *neu1, struct neuron *neu1b2);
    void initNeurons(struct neuron **neu0_p, struct neuron **neu1_p, struct neuron **neuc_p, struct neuron **neu2_p, int **bptt_history_p, neuron **bptt_hidden_p, struct synapse **bptt_syn0_p);
    void initBackupNeurons(struct neuron **neu0b_p, struct neuron **neu1b_p, struct neuron **         neucb_p, struct neuron **neu2b_p, struct neuron **neu1b2_p);
    void initNet();
    void saveNet();
    void goToDelimiter(int delim, FILE *fi);
    void restoreNet();
    void netFlush(struct neuron *neu0, struct neuron *neu1, struct neuron *neuc, struct neuron *neu2);
    void netReset(struct neuron *neu0, struct neuron *neu1, int *bptt_history, neuron *bptt_hidden, int history[]);    //will erase just hidden layer state + bptt history + maxent history (called at end of sentences in the independent mode)
    
    void computeNet(int last_word, int word, struct neuron *neu0, struct neuron *neu1, struct neuron *neuc, struct neuron *neu2, int history[]);
    void learnNet(int last_word, int word, struct neuron *neu0, struct neuron *neu1, struct neuron *neuc, struct neuron *neu2, int *bptt_history, neuron *bptt_hidden, struct synapse *bptt_syn0, int history[], int counter);
    void copyHiddenLayerToInput(struct neuron *neu0, struct neuron *neu1);
    void trainNet();
